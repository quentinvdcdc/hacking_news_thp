...
ActiveRecord::Schema.define(version: 2019_01_30_172854) do
  ...
  create_table "primary_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["link_id"], name: "index_primary_comments_on_link_id"
  ...
  create_table "secondary_comments", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["primary_comment_id"], name: "index_secondary_comments_on_primary_comment_id"
